...
const LANGUAGES = [
    ...
    { code: "am", name: "አማርኛ", region: "Ethiopia" },
];
...
const OptaTab: React.FC = () => {
    return (
        <div className="pb-32 pt-8 md:pt-10 min-h-screen relative overflow-hidden animate-fade-in">
...
const NewsTab: React.FC = () => {
    return (
        <div className="px-5 md:px-8 pt-8 md:pt-10 pb-32 min-h-screen relative animate-fade-in overflow-hidden">
            <div className="relative z-10 space-y-8 md:space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 pb-12">
                    <div onClick={() => window.open("https://www.mirror.co.uk/sport/football/transfer-news", "_blank")} className="bg-slate-900/70 backdrop-blur-xl border border-white/10 p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] hover:bg-slate-950 transition-all cursor-pointer group flex items-center justify-between shadow-2xl">
...
const SettingsTab: React.FC = () => {
    ...
    return (
        <div className="px-4 md:px-8 pt-8 md:pt-10 pb-40 min-h-screen relative animate-fade-in overflow-x-hidden">
                ...
                {activeTab === "live" && (
                    <div className="animate-fade-in flex flex-col min-h-screen pb-32 relative overflow-hidden bg-[radial-gradient(ellipse_at_top,#8CA4AD_0%,#465459_100%)]">
                        ...
                        <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center pt-24 overflow-hidden">
                            ...
                            <div className="absolute top-[5%] h-[95vh] w-full flex flex-col items-center justify-end md:justify-center pointer-events-none perspective-[1000px] z-0 animate-[float_6s_ease-in-out_infinite]">
                                <img 
                                    ...
                                    className="h-[80%] md:h-[90%] w-full object-contain filter drop-shadow-[0_0_50px_rgba(255,215,0,0.6)] contrast-125 saturate-150 brightness-110 opacity-30 md:opacity-40"
                                    alt="World Cup Trophy Realistic" 
                                />
                            </div>
